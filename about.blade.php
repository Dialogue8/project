...
<body>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs">
      <div class="page-header d-flex align-items-center" style="background-image: url('https://source.unsplash.com/JrnDk7qTA7c/950x950');">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          <div class="col-lg-6 position-relative align-self-start order-lg-last order-first">
            <img src="assets/img/3 (1).jpg" class="img-fluid" alt="">
            <a href="https://youtu.be/clZxRZwCDOI" class="glightbox play-btn"></a>
          </div>
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
          ...
          <p>
            ...
            Bandung, 40000<br>
            Jawa Barat <br><br>
            <strong>Telepon:</strong> +62 000 000 00<br>
            <strong>E-Post:</strong> selarastim@gulugulu.com<br>
          </p>
