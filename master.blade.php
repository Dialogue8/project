...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color:#00008b;">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/data_siswa">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('halaman-kurikulum') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('halaman-guru') }}">
